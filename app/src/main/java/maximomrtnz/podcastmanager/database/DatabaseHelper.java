...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRY_ITUNES_IMAGE =
            "CREATE TABLE " + PodcastManagerContract.ItunesImage.TABLE_NAME + " (" +
                    ...
                    PodcastManagerContract.ItunesImage.COLUMN_NAME_PARENT_ID + INTEGER_TYPE + NOT_NULL + COMMA_SEP +
                    PodcastManagerContract.ItunesImage.COLUMN_NAME_PARENT_TYPE + TEXT_TYPE + NOT_NULL +
            " )";
    ...
    private static final String SQL_CREATE_ENTRY_ENCLOSURE =
            "CREATE TABLE " + PodcastManagerContract.Enclosure.TABLE_NAME + " (" +
                    ...
                    PodcastManagerContract.Enclosure.COLUMN_NAME_ITEM_ID + INTEGER_TYPE + UNIQUE + NOT_NULL + COMMA_SEP +
                    FOREIGN_KEY + " ("+PodcastManagerContract.Enclosure.COLUMN_NAME_ITEM_ID+") "+REFERENCES+" "+PodcastManagerContract.Item.TABLE_NAME+"("+PodcastManagerContract.Item.COLUMN_NAME_ID+") " + ON_DELETE_CASCADE +
            " )";
    ...
    private static final String SQL_CREATE_ENTRY_CHANNEL =
            "CREATE TABLE " + PodcastManagerContract.Channel.TABLE_NAME + " (" +
                    ...
                    PodcastManagerContract.Channel.COLUMN_NAME_ITUNES_OWNER_ID + INTEGER_TYPE + NOT_NULL + COMMA_SEP +
                    ...
                    FOREIGN_KEY + " ("+PodcastManagerContract.Channel.COLUMN_NAME_ITUNES_OWNER_ID+") "+REFERENCES+" "+PodcastManagerContract.ItunesOwner.TABLE_NAME+"("+PodcastManagerContract.ItunesOwner.COLUMN_NAME_ID+") " + ON_DELETE_CASCADE +
            " )";
    ...
    private static final String SQL_CREATE_ENTRY_ITEM =
            "CREATE TABLE " + PodcastManagerContract.Item.TABLE_NAME + " (" +
                    ...
                    PodcastManagerContract.Item.COLUMN_NAME_CHANNEL_ID + INTEGER_TYPE + NOT_NULL + COMMA_SEP +
