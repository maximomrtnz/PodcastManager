 ...
 */
public class PlaybackManager implements AudioManager.OnAudioFocusChangeListener,OnCompletionListener {
    ...
    public void play(MediaMetadataCompat metadata) {
        ...
        if (mediaChanged) {
            ...
            try {
                mMediaPlayer.setDataSource(mContext.getApplicationContext(), Uri.parse(EpisodePlaylist.getInstance().getEpisodeUri(mediaId)));
    ...
    private void updatePlaybackState() {
        ...
        long actions = PlaybackStateCompat.ACTION_PLAY | PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID | PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH | PlaybackStateCompat.ACTION_SKIP_TO_NEXT  | PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS;
